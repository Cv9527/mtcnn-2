...
"E:\project\3.github\CCDL2\CCDL\caffe-easy\windows-gpu\convert_imageset\../../Build/gpu_cuda8.0/Release/x64/convert_imageset.exe" "" 24/label-train.txt train_lmdb24 --backend=mtcnn --shuffle=true
echo LMDB数据库创建完毕。
pause